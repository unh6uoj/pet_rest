...
class HX711:
    ...
    def readRawBytes(self):
        ...
        rawSample = self.convertToTwosComplement24bit(
            self.generateFakeSample())
    ...
    def generateFakeSample(self):
        ...
        noiseScale = 1.0
        noiseValue = random.randrange(-(noiseScale * 1000),
                                      (noiseScale * 1000)) / 1000.0
        ...
        if random.randrange(0, BIG_ERROR_SAMPLE_FREQUENCY) == 0:
            ...
            print("Sample %d: Injecting %f as a random bad sample." %
